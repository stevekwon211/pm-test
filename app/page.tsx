        ...
        return (
            <main className="flex min-h-screen flex-col items-center justify-center p-24">
                <Modal>
                    ...
                    <div>
                        <p className="subtext">
                            당신은 한국의 시리즈B 규모의 패션 커머스 스타트업 '센드스타일(SendStyle)'의 신임 PM으로
                            합류했습니다. 회사는 현재 다음과 같은 도전에 직면해 있습니다.
                            <br />
                            <br />
                            - 최근 3개월간 매출 15% 하락
                            <br />
